# YOLOv11 Insect Detection System

## Body

YOLOv11 Insect Detection System Based on Deep Learning YOLOv11, Including the YOLOv11+YOLO dataset, UI interface, login and registration interfaces, Python project source code, and models.
...
Dataset quantity: training set 696 images, validation set 199 images, test set 100 images.
